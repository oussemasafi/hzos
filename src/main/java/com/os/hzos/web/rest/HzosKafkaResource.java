...
@RestController
@RequestMapping("/api/hzos-kafka")
public class HzosKafkaResource {
    private final Logger log = LoggerFactory.getLogger(HzosKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HzosKafkaResource(KafkaProperties kafkaProperties) {
